...
public class Teacher extends Person{
    ...
    public Teacher(String id, String fullName, boolean sex, LocalDate birthDay, String cityBorn, String address, String phoneNumber, String email, String password, String facultyID, TeacherLevel level) {
    ...
    public Teacher(String id, String fullName, boolean sex, LocalDate birthDay, String cityBorn, String address, String phoneNumber, String email, String avatar, String password, String facultyID, TeacherLevel level) {

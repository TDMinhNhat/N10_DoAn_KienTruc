...
public class CourseClassScheduled {
    ...
    public CourseClassScheduled(long id, String room, int fromLessonTime, int toLessonTime, LocalDate fromDate, LocalDate toDate, int groupPractice, int maxStudents, String teacherId, CourseClass courseClassID) {
        this.id = id;
        this.room = room;

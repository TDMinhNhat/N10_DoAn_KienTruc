...
public class CourseClass {
    ...
    public CourseClass(String courseClassId, String shortName, String fullName, String semesterYear, Faculty facultyID, String courseID, int semester, CourseClassStatus status) {
